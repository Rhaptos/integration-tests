...
class Importing(unittest.TestCase):
    ...
    This test...
      ...
      * Changes  the print parameter to "CCAP Biology"
    ...
    def test_importing(self):
        ...
        checkbox.click()
        content_add = self.driver.find_elements_by_name('form.button.ContextAdd')
        content_add[0].click()
        #change print style parameter
        parameter_tab = self.driver.find_element_by_link_text('Parameters')
        parameter_tab.click()
        printstyle = self.driver.find_element_by_name('printstyle')
        for option in printstyle.find_elements_by_tag_name('option'):
            if option.text == 'CCAP Biology':
                option.click()
                break
        update_parameters = self.driver.find_element_by_name('submit')
        update_parameters.click()
        #publish
